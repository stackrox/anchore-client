...
func (a *SubscriptionsApiService) AddSubscription(ctx context.Context, subscription SubscriptionRequest, localVarOptionals *AddSubscriptionOpts) (SubscriptionList, *http.Response, error) {
	var (
...
func (a *SubscriptionsApiService) GetSubscription(ctx context.Context, subscriptionId string, localVarOptionals *GetSubscriptionOpts) (SubscriptionList, *http.Response, error) {
	var (
...
func (a *SubscriptionsApiService) ListSubscriptions(ctx context.Context, localVarOptionals *ListSubscriptionsOpts) (SubscriptionList, *http.Response, error) {
	var (
		localVarHttpMethod  = strings.ToUpper("Get")
		localVarPostBody    interface{}
		localVarFileName    string
...
func (a *SubscriptionsApiService) UpdateSubscription(ctx context.Context, subscriptionId string, subscription SubscriptionUpdate, localVarOptionals *UpdateSubscriptionOpts) (SubscriptionList, *http.Response, error) {
	var (
