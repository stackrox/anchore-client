...
func (a *ImagesApiService) AddImage(ctx context.Context, image ImageAnalysisRequest, localVarOptionals *AddImageOpts) (AnchoreImageList, *http.Response, error) {
	var (
...
func (a *ImagesApiService) GetImage(ctx context.Context, imageDigest string, localVarOptionals *GetImageOpts) (AnchoreImageList, *http.Response, error) {
	var (
...
func (a *ImagesApiService) GetImageByImageId(ctx context.Context, imageId string, localVarOptionals *GetImageByImageIdOpts) (AnchoreImageList, *http.Response, error) {
	var (
		localVarHttpMethod  = strings.ToUpper("Get")
		localVarPostBody    interface{}
		localVarFileName    string
...
func (a *ImagesApiService) ListImages(ctx context.Context, localVarOptionals *ListImagesOpts) (AnchoreImageList, *http.Response, error) {
	var (
		localVarHttpMethod  = strings.ToUpper("Get")
		localVarPostBody    interface{}
		localVarFileName    string
