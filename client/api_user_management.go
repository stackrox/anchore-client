...
func (a *UserManagementApiService) ListAccounts(ctx context.Context, localVarOptionals *ListAccountsOpts) (AccountList, *http.Response, error) {
	var (
		localVarHttpMethod  = strings.ToUpper("Get")
		localVarPostBody    interface{}
		localVarFileName    string
