...
func (a *PoliciesApiService) GetPolicy(ctx context.Context, policyId string, localVarOptionals *GetPolicyOpts) (PolicyBundleList, *http.Response, error) {
	var (
...
func (a *PoliciesApiService) ListPolicies(ctx context.Context, localVarOptionals *ListPoliciesOpts) (PolicyBundleList, *http.Response, error) {
	var (
		localVarHttpMethod  = strings.ToUpper("Get")
		localVarPostBody    interface{}
		localVarFileName    string
...
func (a *PoliciesApiService) UpdatePolicy(ctx context.Context, bundle PolicyBundleRecord, policyId string, localVarOptionals *UpdatePolicyOpts) (PolicyBundleList, *http.Response, error) {
	var (
