...
# **AddImage**
> AnchoreImageList AddImage(ctx, image, optional)
...
# **GetImage**
> AnchoreImageList GetImage(ctx, imageDigest, optional)
Get image metadata
...
# **GetImageByImageId**
> AnchoreImageList GetImageByImageId(ctx, imageId, optional)
...
# **ImportImage**
> AnchoreImageList ImportImage(ctx, analysisReport, optional)
 ...
 **optional** | ***ImportImageOpts** | optional parameters | nil if no parameters

### Optional Parameters
Optional parameters are passed through a pointer to a ImportImageOpts struct
...
# **ListImages**
> AnchoreImageList ListImages(ctx, optional)
