...
# **AddSubscription**
> SubscriptionList AddSubscription(ctx, subscription, optional)
...
# **GetSubscription**
> SubscriptionList GetSubscription(ctx, subscriptionId, optional)
...
# **UpdateSubscription**
> SubscriptionList UpdateSubscription(ctx, subscriptionId, subscription, optional)
